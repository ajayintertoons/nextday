...
const PickupSection1 = ({ formik, setIsReversePickup, isReversePickup, isToPay, setIsToPay }) => {
  ...
  return (
    <>
      ...
      <div className="container mx-auto  px-3">
        ...
        <div className="relative grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 gap-4 p-4 ">
          <Dropdown
            title="Mode Type"
            options={options}
            placeholder="Select"
            name="modeType"
            value={options.find(
              (option) => option.value === formik.values.modeType
            )}
            onChange={(option) =>
          ...
          <div className="" style={{ marginTop: "10px" }}>
            ...
            <Select
              ...
              placeholder="Select"
              name="boxType"
              value={options2.find((option) => option?.value === formik.values?.boxType)}
              onChange={(option) => formik.setFieldValue(`boxType`, option?.value)}
              styles={{
                control: (provided) => ({
                  ...provided,
                  minHeight: '52px',
              ...
              isClearable={true}
            />
            {/* {formik.errors.boxType && <span className="text-[#FF0000] text-sm">This field is required</span>} */}
            {formik.touched.boxType && formik.errors.boxType && (
              <span className="text-[#FF0000] text-sm">This field is required</span>
            )}
          ...
          <div className="flex">
            <div className="items-center flex mt-3 mx-5">
              <div>
                <div className="flex gap-2 relative">
                  <h5 className="bold-sansation">To Pay</h5>
                  <div className="group ">
            ...
            <div className="items-center flex mt-3 mx-5">
              <div>
                <div className="flex gap-2 relative">
                  <h5 className="bold-sansation">Reverse Pickup</h5>
                  <div className="group ">
                    <MdInfo className="text-[#FFE603]" />
                    {/* display text when hovering over the info icon */}
                    <div className="absolute hidden group-hover:block bg-[#9A9A9A] pt-3 text-custom-white text-sm px-2  py-1 rounded-md w-48 top-1/2 transform -translate-y-1/2 mx-8 z-10">
