...
import cargo from "../../images/9.png.png";
    ...
    <>
      {/* ---------------- main div ------------------ */}
        ...
        >
          ...
          {/* -------------------- sub div ------------------ */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2  sm:p-0 md:p-0 lg:p-0 p-3   mx-10 ">
            {/* ---------- delivery image ---------- */}
            ...
            <div className="  grid-col-span-1 ">
              ...
              <div className="container mx-auto pt-4 ">
                <div className="grid sm:grid-cols-2 grid-cols-1 gap-[30px]">
                  <img src={cargo} alt="Cargo containers" className="w-full h-[350px]"/>
