            ...
            ${selected === index
              ...
              <div className="flex justify-center items-center h-auto mx-3 mb-3 ">
                <SearchInput
                  ...
                  Icon={FiSearch}
                  className=" w-full py-1 md:w-3/4"
                />
                <button onClick={handleSearch} type="submit" className="bg-custom-green flex items-center  justify-center rounded-md text-white font-sansation font-regular mt-2 py-2 ms-2 px-3">Search</button>
              </div>
            </div>
